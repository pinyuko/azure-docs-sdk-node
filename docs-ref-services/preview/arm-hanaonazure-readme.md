...
keywords: Azure, javascript, SDK, API, @azure/arm-hanaonazure, saphanaonazure
author: qiaozha
ms.author: qiaozha
ms.date: 02/04/2022
ms.topic: reference
...
---
# Azure HanaManagement client library for JavaScript - Version 4.0.0-alpha.20220204.1 
