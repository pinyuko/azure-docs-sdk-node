...
keywords: Azure, javascript, SDK, API, @azure/arm-visualstudio, visualstudioteamservices
author: qiaozha
ms.author: qiaozha
ms.date: 02/25/2022
ms.topic: reference
...
---
# Azure Visual Studio Resource Provider client library for JavaScript - Version 4.0.0-alpha.20220225.1 
