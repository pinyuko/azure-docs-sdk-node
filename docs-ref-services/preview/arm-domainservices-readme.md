...
keywords: Azure, javascript, SDK, API, @azure/arm-domainservices, activedirectorydomainservices
author: qiaozha
ms.author: qiaozha
ms.date: 02/07/2022
ms.topic: reference
...
ms.service: activedirectorydomainservices
---
# Azure Domain client library for JavaScript - Version 4.0.1-alpha.20220207.1 
