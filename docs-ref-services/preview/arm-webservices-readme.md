...
keywords: Azure, javascript, SDK, API, @azure/arm-webservices, webservices
author: qiaozha
ms.author: qiaozha
ms.date: 03/12/2022
ms.topic: reference
...
---
# Azure ML Web Services Management client library for JavaScript - Version 1.0.0-alpha.20220311.1 
