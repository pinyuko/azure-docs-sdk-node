...
keywords: Azure, javascript, SDK, API, @azure/arm-storagecache, storage
author: qiaozha
ms.author: qiaozha
ms.date: 02/14/2022
ms.topic: reference
...
ms.service: storage
---
# Azure StorageCacheManagement client library for JavaScript - Version 5.0.0-alpha.20220214.1 
