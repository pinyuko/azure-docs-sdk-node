...
keywords: Azure, javascript, SDK, API, @azure/arm-powerbidedicated, powerbiembedded
author: qiaozha
ms.author: qiaozha
ms.date: 03/11/2022
ms.topic: reference
...
---
# Azure Service client library for JavaScript - Version 3.0.0-alpha.20220311.1 
