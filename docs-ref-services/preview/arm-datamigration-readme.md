...
keywords: Azure, javascript, SDK, API, @azure/arm-datamigration, databasemigrationservice
author: qiaozha
ms.author: qiaozha
ms.date: 01/25/2022
ms.topic: reference
...
---
# Azure DataMigrationManagement client library for JavaScript - Version 3.0.0-alpha.20220124.1 
