...
keywords: Azure, javascript, SDK, API, @azure/arm-machinelearningexperimentation, machinelearning
author: qiaozha
ms.author: qiaozha
ms.date: 02/03/2022
ms.topic: reference
...
---
# Azure ML Team Account Management client library for JavaScript - Version 2.0.0-alpha.20220202.1 
