...
keywords: Azure, javascript, SDK, API, @azure/arm-databoxedge, stackedge
author: qiaozha
ms.author: qiaozha
ms.date: 01/21/2022
ms.topic: reference
...
---
# Azure DataBoxEdgeManagement client library for JavaScript - Version 2.0.1-alpha.20220121.1 
