...
keywords: Azure, javascript, SDK, API, @azure/arm-workspaces, workspaces
author: qiaozha
ms.author: qiaozha
ms.date: 03/08/2022
ms.topic: reference
...
---
# Azure Machine Learning Workspaces Management client library for JavaScript - Version 1.0.0-alpha.20220307.1 
