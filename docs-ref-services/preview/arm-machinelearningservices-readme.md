...
keywords: Azure, javascript, SDK, API, @azure/arm-machinelearningservices, machinelearning
author: qiaozha
ms.author: qiaozha
ms.date: 01/29/2022
ms.topic: reference
...
---
# Azure Service client library for JavaScript - Version 5.0.0-alpha.20220128.1 
