...
keywords: Azure, javascript, SDK, API, @azure/arm-operations, loganalytics
author: qiaozha
ms.author: qiaozha
ms.date: 03/09/2022
ms.topic: reference
...
---
# Azure OperationsManagement client library for JavaScript - Version 4.0.0-alpha.20220308.1 
