...
keywords: Azure, javascript, SDK, API, @azure/arm-vmwarecloudsimple, vmwarebycloudsimple
author: qiaozha
ms.author: qiaozha
ms.date: 02/08/2022
ms.topic: reference
...
---
# Azure Service client library for JavaScript - Version 2.0.0-alpha.20220208.1 
