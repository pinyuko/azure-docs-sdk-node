...
keywords: Azure, javascript, SDK, API, @azure/arm-powerbiembedded, powerbi
author: qiaozha
ms.author: qiaozha
ms.date: 01/24/2022
ms.topic: reference
...
ms.service: powerbi
---
# Azure Power BI Embedded Management client library for JavaScript - Version 2.0.0-alpha.20220124.1 
