...
keywords: Azure, javascript, SDK, API, @azure/arm-recoveryservices-siterecovery, recoveryservices
author: qiaozha
ms.author: qiaozha
ms.date: 02/24/2022
ms.topic: reference
...
---
# Azure SiteRecoveryManagement client library for JavaScript - Version 4.0.0-alpha.20220223.1 
